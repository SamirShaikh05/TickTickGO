...
//   return (
//     <div>
//       <div className="container bg-gradient-to-br from-blue-50 to-indigo-100 p-5 w-[95vw] sm:w-[80vw] md:w-[60vw] lg:w-[45vw] xl:w-[35vw] h-[85vh] mt-[7.5vh] mx-auto rounded-xl shadow-xl border border-indigo-200 flex flex-col">
//         <h1 className='text-center text-2xl font-bold text-indigo-800'>TickTickGo-Check It. Done It. Go.</h1>
//         <h2 className='text-2xl font-semibold mt-3 text-indigo-700'>Add a Todo</h2>
//         <div className="flex gap-2 justify-center mt-5">
//           <input
...
//         <h2 className='text-2xl font-semibold text-indigo-700 mb-4'>Your Todos</h2>
//         <div className="todos max-h-[45vh] overflow-y-auto pr-2 custom-scrollbar">
//           {
//             todos
//               .filter((item) => showfinished || !item.done)
//               .map((item, index) => {
//                 return (
//                   <div className='flex flex-col mb-3 relative w-full bg-white bg-opacity-60 p-3 rounded-lg border border-indigo-200 shadow-sm' key={index}>
//                     <div className='flex justify-between items-start'>
//                       <div className='todo flex gap-2 items-start relative w-[75%]'>
//                         <input
//                           type="checkbox"
//                           onChange={() => handleCheckbox(index)}
//                           checked={item.done}
//                           id={`todo-${index}`}
//                           className='hover:cursor-pointer accent-indigo-600 mt-1'
//                         />
//                         {editIndex === index ? (
//                           <input
//                             type="text"
//                             value={editText}
//                             onChange={(e) => setEditText(e.target.value)}
//                             className="border-2 border-indigo-400 rounded-lg px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-indigo-50 shadow-sm"
//                             onKeyPress={(e) => e.key === 'Enter' && handleSaveEdit()}
//                           />
//                         ) : (
//                           <div className={`text-lg ${item.done ? "line-through text-gray-400" : "text-gray-700"} hover:cursor-default flex-1 break-words`}>
//                             {item.text}
//                           </div>
//                         )}
//                       </div>
...
//                           className='bg-red-500 hover:bg-red-600 p-2 py-1 text-sm font-bold text-white rounded-md mx-1 hover:cursor-pointer transition-colors shadow-sm'
//                         >
//                           <AiFillDelete />
//                         </button>
//                       </div>
...
//               })
//           }
//           {todos.filter((item) => showfinished || !item.done).length === 0 && (
//             <div className='text-center text-gray-500 mt-8'>
//               {todos.length === 0 ? 'No todos yet. Add one above!' : 'No todos to show.'}
//             </div>
//           )}
//         </div>
//       </div>
