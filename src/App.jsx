        ...
        <div className="todos max-h-[40vh] overflow-y-auto pr-2 custom-scrollbar">
          {
            todos
              ...
              .map((item, index) => {
                return (
                  <div className='flex justify-between items-center mb-3 relative w-full bg-white bg-opacity-60 p-3 rounded-lg border border-indigo-200 shadow-sm' key={index}>
